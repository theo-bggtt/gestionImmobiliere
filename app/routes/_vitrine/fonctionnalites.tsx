    ...
    <>
      <section className="v-heros v-heros-simple">
        <div className="v-heros-texte">
          <p className="v-surtitre">Ce que ça fait</p>
      ...
      <ul className="v-cartes v-cartes-larges">
        <li className="v-carte">
          ...
          <p>
            La cave et le fond du jardin sont exactement là où l'on a besoin de noter quelque chose,
            et là où le réseau manque. La capture est conçue pour y tenir : ce qui est photographié
            sans réseau attend sur le téléphone. C'est le dessein, constaté au navigateur ; tant qu'il
            n'a pas été éprouvé dans une vraie cave, cette page ne le promet pas.
          </p>
        </li>
        <li className="v-carte">
          <h3>Retrouver d'un mot</h3>
          <p>
            Nom, surnoms, type, zone, système, contenu des champs : la recherche lit tout, ignore les
            accents parce que personne ne les tape depuis un téléphone, et vous dit sur quoi elle a
            trouvé.
          </p>
          <p>
        ...
        <li className="v-carte">
          ...
          <p>
            ...
            siphon, chacun avec les champs qui vont avec. Créez les vôtres, avec les champs que vous
            voulez.
          </p>
          <p>
        ...
        <li className="v-carte">
          ...
          <p>
            Elle propose, vous décidez : rien ne change de zone sans votre accord, parce que la zone
            d'un objet est ce qui décide qui a le droit de le voir.
          </p>
        </li>
        <li className="v-carte">
          <h3>L'historique</h3>
          <p>
            Dépannage, rénovation, sinistre, entretien : un événement se rattache aux objets concernés
            et aux personnes intervenues, avec les photos d'avant et d'après.
          </p>
        ...
        <li className="v-carte">
          ...
          <p>
            Une garantie tient à l'objet qu'elle couvre, avec sa date de fin et son document. L'accueil
            vous montre celles qui arrivent à terme, et la fiche de l'objet dit si la sienne court
            encore, au moment où vous êtes devant la chaudière qui fuit.
          </p>
          <p>
        ...
        <li className="v-carte">
          ...
          <p>
            ...
            événements où elle est intervenue. Son téléphone et vos notes sur elle restent chez vous :
            aucun lien de partage ne les emporte, quel que soit son plafond.
          </p>
        </li>
        <li className="v-carte">
      ...
      <section className="v-final">
        <div>
          <h2>Tout ça, à partir d'une photo.</h2>
          <p>
