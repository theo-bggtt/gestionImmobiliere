...
export type Entree = { nom: string; icone: string; niveauSuggere: number; champs: ChampDefinition[]; alias: string[] };
...
export const CATALOGUE: Entree[] = [
  ...
  { nom: "Prise RJ45", icone: "network", alias: ["prise réseau", "prise ethernet", "prise informatique"], niveauSuggere: 1, champs: [
    champ({ cle: "emplacement", label: "Emplacement", genre: "texte" }),
    champ({ cle: "brasse_vers", label: "Brassée vers", genre: "texte", niveauMin: 2, unite: "panneau de brassage / baie" }),
    champ({ cle: "notes", label: "Notes", genre: "texte" }),
  ]},
  { nom: "Interrupteur", icone: "toggle-left", alias: ["interrupteur", "va-et-vient", "variateur"], niveauSuggere: 1, champs: [
  ...
  { nom: "Luminaire", icone: "lightbulb", alias: ["luminaire", "lampe", "plafonnier", "applique"], niveauSuggere: 1, champs: [
  ...
  { nom: "Robinet", icone: "droplet", alias: ["mitigeur", "robinetterie"], niveauSuggere: 1, champs: [
  ...
  { nom: "Chauffe-eau", icone: "flame", alias: ["ballon d'eau chaude", "cumulus", "boiler"], niveauSuggere: 2, champs: [
  ...
  { nom: "Chaudière", icone: "flame", alias: ["chaudière", "chauffage central"], niveauSuggere: 2, champs: [
  ...
  { nom: "Radiateur", icone: "thermometer", alias: ["radiateur", "chauffage"], niveauSuggere: 1, champs: [
    champ({ cle: "type", label: "Type", genre: "choix", options: ["eau chaude", "électrique", "sèche-serviettes"] }),
    champ({ cle: "puissance", label: "Puissance", genre: "nombre", unite: "W" }),
  ]},
  { nom: "Thermostat", icone: "thermometer", alias: ["thermostat", "régulateur de température"], niveauSuggere: 1, champs: [
  ...
  { nom: "Bouche de VMC", icone: "wind", alias: ["ventilation", "VMC", "bouche d'aération", "extraction d'air"], niveauSuggere: 1, champs: [
  ...
  { nom: "Lave-linge", icone: "washing-machine", alias: ["machine à laver", "lave-linge"], niveauSuggere: 1, champs: [
    champ({ cle: "marque", label: "Marque", genre: "texte" }),
    champ({ cle: "modele", label: "Modèle", genre: "texte" }),
    champ({ cle: "date_achat", label: "Date d'achat", genre: "date" }),
    champ({ cle: "garantie_jusquau", label: "Garantie jusqu'au", genre: "date" }),
  ]},
  { nom: "Lave-vaisselle", icone: "washing-machine", alias: ["lave-vaisselle"], niveauSuggere: 1, champs: [
    champ({ cle: "marque", label: "Marque", genre: "texte" }),
    champ({ cle: "modele", label: "Modèle", genre: "texte" }),
    champ({ cle: "date_achat", label: "Date d'achat", genre: "date" }),
    champ({ cle: "garantie_jusquau", label: "Garantie jusqu'au", genre: "date" }),
  ]},
  { nom: "Four", icone: "cooking-pot", alias: ["four", "four encastrable"], niveauSuggere: 1, champs: [
    champ({ cle: "type", label: "Type", genre: "choix", options: ["encastrable", "pose libre", "vapeur", "micro-ondes combiné"] }),
    champ({ cle: "marque", label: "Marque", genre: "texte" }),
    champ({ cle: "date_achat", label: "Date d'achat", genre: "date" }),
  ]},
  { nom: "Hotte", icone: "fan", alias: ["hotte", "hotte aspirante", "extracteur de cuisine"], niveauSuggere: 1, champs: [
    champ({ cle: "type", label: "Type", genre: "choix", options: ["aspirante", "recyclage"] }),
    champ({ cle: "marque", label: "Marque", genre: "texte" }),
  ]},
  { nom: "Porte", icone: "door-open", alias: ["porte", "porte d'entrée", "porte-fenêtre"], niveauSuggere: 1, champs: [
  ...
  { nom: "Fenêtre", icone: "square", alias: ["fenêtre", "châssis", "baie vitrée"], niveauSuggere: 1, champs: [
  ...
  { nom: "Compteur électrique", icone: "gauge", alias: ["compteur électrique", "compteur EDF", "compteur d'électricité"], niveauSuggere: 2, champs: [
  ...
  { nom: "Compteur d'eau", icone: "gauge", alias: ["compteur d'eau", "compteur d'eau froide"], niveauSuggere: 2, champs: [
    champ({ cle: "numero_compteur", label: "Numéro de compteur", genre: "texte", niveauMin: 2 }),
    champ({ cle: "fournisseur", label: "Fournisseur", genre: "texte" }),
  ]},
  { nom: "Gaine technique", icone: "route", alias: ["gaine", "gaine technique", "chemin de câbles", "colonne montante"], niveauSuggere: 2, champs: [
    champ({ cle: "contenu", label: "Contenu", genre: "texte", niveauMin: 2 }),
    champ({ cle: "trajet", label: "Trajet", genre: "texte", niveauMin: 2 }),
  ]},
  // ── Extérieur ──────────────────────────────────────────────────────
  { nom: "Vanne d'arrosage", icone: "droplet", alias: ["vanne d'arrosage", "électrovanne", "arrosage"], niveauSuggere: 1, champs: [
    champ({ cle: "zone_arrosee", label: "Zone arrosée", genre: "texte" }),
    champ({ cle: "type", label: "Type", genre: "choix", options: ["manuelle", "électrovanne"] }),
  ]},
  { nom: "Programmateur d'arrosage", icone: "clock", alias: ["programmateur", "programmateur d'arrosage", "minuterie d'arrosage"], niveauSuggere: 2, champs: [
    champ({ cle: "nombre_zones", label: "Nombre de zones", genre: "nombre" }),
    champ({ cle: "marque", label: "Marque", genre: "texte" }),
  ]},
  { nom: "Éclairage extérieur", icone: "lightbulb", alias: ["éclairage extérieur", "spot extérieur", "luminaire extérieur"], niveauSuggere: 1, champs: [
    champ({ cle: "type", label: "Type", genre: "choix", options: ["spot", "borne", "guirlande", "détecteur de mouvement"] }),
    champ({ cle: "commande", label: "Commandé par", genre: "texte" }),
  ]},
  { nom: "Portail motorisé", icone: "door-open", alias: ["portail", "portail électrique", "portail automatique"], niveauSuggere: 1, champs: [
  ...
  { nom: "Clôture", icone: "fence", alias: ["clôture", "grillage", "haie", "mur de clôture"], niveauSuggere: 1, champs: [
    champ({ cle: "materiau", label: "Matériau", genre: "texte" }),
    champ({ cle: "hauteur", label: "Hauteur", genre: "nombre", unite: "m" }),
    champ({ cle: "longueur", label: "Longueur", genre: "nombre", unite: "m" }),
  ]},
  { nom: "Regard", icone: "square", alias: ["regard", "regard d'égout", "tampon"], niveauSuggere: 2, champs: [
  ...
  { nom: "Fosse", icone: "container", alias: ["fosse septique", "fosse toutes eaux", "assainissement"], niveauSuggere: 2, champs: [
  ...
  { nom: "Pompe à chaleur extérieure", icone: "fan", alias: ["pompe à chaleur", "PAC", "unité extérieure"], niveauSuggere: 2, champs: [
    champ({ cle: "type", label: "Type", genre: "choix", options: ["air-eau", "air-air"] }),
    champ({ cle: "marque", label: "Marque", genre: "texte" }),
    champ({ cle: "puissance", label: "Puissance", genre: "nombre", unite: "kW" }),
    champ({ cle: "date_installation", label: "Date d'installation", genre: "date" }),
  ]},
  { nom: "Prise extérieure", icone: "power-plug", alias: ["prise extérieure", "prise de jardin"], niveauSuggere: 1, champs: [
    champ({ cle: "emplacement", label: "Emplacement", genre: "texte" }),
    champ({ cle: "etanche", label: "Étanche", genre: "booleen" }),
  ]},
  { nom: "Cuve", icone: "container", alias: ["cuve", "citerne", "réservoir"], niveauSuggere: 2, champs: [
...
async function main() {
  const valeurs = CATALOGUE.map((entree) => ({
    ...
    alias: entree.alias,
    niveauSuggere: entree.niveauSuggere,
  }));
  ...
  //
  // `alias` est rafraîchi sur conflit : c'est du vocabulaire de recherche pur,
  // l'enrichir est justement l'objet de l'étape 2, et le déclencheur de
  // propagation de la migration 0003 recalcule tout seul element.recherche des
  // fiches concernées. `champs` n'est PAS rafraîchi —
  ...
  //
  // `niveau_suggere` suit `alias` et non `champs` : c'est du vocabulaire de
  // catalogue, pas une donnée du propriétaire. Un type système n'est pas
  // éditable, donc personne n'a rien à écraser ici ; et la correction du
  // propriétaire vit sur la FICHE (`element.niveau`), que ce rafraîchissement
  // ne touche pas — une suggestion ne se propage jamais aux objets déjà posés.
  const ecrites = await db
    ...
    .onConflictDoUpdate({
      ...
      set: { alias: sql`excluded.alias`, niveauSuggere: sql`excluded.niveau_suggere` },
    })
    .returning({ nom: schema.typeElement.nom });

  console.log(`Catalogue : ${ecrites.length} types sur ${CATALOGUE.length} écrits (créés, ou alias et niveau suggéré rafraîchis).`);
  await pool.end();
}
